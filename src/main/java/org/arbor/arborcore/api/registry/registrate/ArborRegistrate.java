package org.arbor.arborcore.api.registry.registrate;
...
public class ArborRegistrate extends GTRegistrate {
    protected ArborRegistrate(String modId) {
        super(modId);
    }

    @Nonnull
    public static ArborRegistrate create(String modId) {
        return new ArborRegistrate(modId) {
        };
    }

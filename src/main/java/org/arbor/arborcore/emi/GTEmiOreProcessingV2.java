package org.arbor.arborcore.emi;
...
public class GTEmiOreProcessingV2 implements EmiRecipe {
    ...
    public static final EmiTexture BASE = new EmiTexture(ArborCore.id("textures/gui/arrows/base.png"), 3, 3, WIDTH, HEIGHT, WIDTH, HEIGHT, TEXTURE_WIDTH, TEXTURE_HEIGHT);
    ...
    public static void addTank(WidgetHolder widgets, EmiIngredient stack, int x, int y) {
        long amount = stack.getAmount();
        long minHeight = 3;
        long capacity = 16 * amount / FluidHelper.getBucket() < minHeight ? amount * 16 / minHeight : Math.max(amount, FluidHelper.getBucket());
        widgets.addTank(stack, x, y, EmiTexture.SLOT.width, EmiTexture.SLOT.height, (int) capacity);
    }
    @ApiStatus.Internal
    ...
    public void addWidgets(WidgetHolder widgets) {
        ...
        widgets.addSlot(getCrushed2().copy().setAmount(1), 0, 102 - 6);
        widgets.addSlot(CAULDRON, 0, 102 + 1 + 18 - 6).drawBack(false);
        int yLastLine = 102 + 18 + 1 + 18 + 3 - 6;

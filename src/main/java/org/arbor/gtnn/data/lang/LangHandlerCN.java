...
public class LangHandlerCN extends LanguageProvider {
    ...
    private void addMachine() {
        add("block.gtnn.chemical_plant", "埃克森美孚化工厂");
        add("gtceu.chemical_plant", "埃克森美孚化工厂");
        add("gtnn.recipe.condition.plant_casing.tooltip", "外壳等级: %s (%s)");
        add("gtnn.multiblock.pattern.error.plant_casings", "所有外壳必须相同");
        add("gtnn.multiblock.pattern.error.pipe", "所有管道必须相同");
        add("gtnn.multiblock.pattern.error.machine_casing", "所有机械方块必须相同");
        ...
        add("block.gtnn.lv_neutron_accelerator", "§7LV中子加速器");
        add("block.gtnn.mv_neutron_accelerator", "§bMV中子加速器");
        add("block.gtnn.hv_neutron_accelerator", "§6HV中子加速器");
        add("block.gtnn.ev_neutron_accelerator", "§5EV中子加速器");
        add("block.gtnn.iv_neutron_accelerator", "§1IV中子加速器");
        add("block.gtnn.luv_neutron_accelerator", "§dLuV中子加速器");
        add("block.gtnn.zpm_neutron_accelerator", "§cZPM中子加速器");
        add("block.gtnn.uv_neutron_accelerator", "§3UV中子加速器");
        ...
        add("block.gtnn.neutron_activator", "中子活化器");
        ...
        add("gtnn.recipe.condition.neutron_activator_condition_tooltip", "最小中子动能:\n%s MeV\n最大中子动能:\n%s MeV");
    }

    private void addThings(){
        add("itemGroup.gtnn.gtnn", "GTNN");
        add("block.gtnn.high_speed_pipe_block", "高速管道方块");
        add("block.gtnn.clean_machine_casing", "洁净机器方块");
        add("item.gtnn.radioactive_waste", "放射性废料");
    }

...
public class MaterialLang {
    public static void init(RegistrateLangProvider provider) {
        ...
        provider.add("material.andesite_alloy", "安山合金");
        provider.add("material.space_neutronium", "中子");
        provider.add("material.infinity", "无尽");
        provider.add("material.infinity_catalyst", "无尽催化剂");
        provider.add("material.desh", "戴斯");
        provider.add("material.ostrum", "紫金");
        provider.add("material.calorite", "耐热金属");
        provider.add("material.rp_1_mixed_fuel", "RP-1混合燃料");
        provider.add("material.rp_1_rocket_fuel", "RP-1火箭燃料");
        provider.add("material.kerosene", "煤油");
        provider.add("material.dense_hydrazine_mixed_fuel", "浓缩肼混合燃料");
        provider.add("material.hydrazine", "肼");
        provider.add("material.hydrogen_peroxide", "过氧化氢");
        provider.add("material.ethyl_anthra_quinone", "乙基蒽醌");
        provider.add("material.ethyl_anthra_hydro_quinone", "乙基蒽醌醇");
        provider.add("material.anthracene", "蒽");
        provider.add("material.methylhydrazine_nitrate_rocket_fuel", "CN3H7O3火箭燃料");
        provider.add("material.methyl_hydrazine", "甲基肼");
        provider.add("material.udmh_rocket_fuel", "H8N4C2O4火箭燃料");
        provider.add("material.udmh", "偏二甲肼");
        provider.add("material.orange_metal_catalyst", "橙色金属催化剂");
        provider.add("material.phthalic_anhydride", "邻苯二甲酸酐");
        provider.add("material.vanadium_pentoxide", "五氧化二钒");
        provider.add("material.black_matter", "黑物质");
        provider.add("material.cerrobase_140", "铋铅合金140");
        provider.add("material.mana_steel", "魔力钢");
        provider.add("material.terra_steel", "泰拉钢");
        provider.add("material.elementium", "源质钢");
        provider.add("material.shadow_steel", "暗影钢");
        provider.add("material.refined_radiance", "光辉石");
        provider.add("material.platinum_salt", "铂盐");
        provider.add("material.platinum_slag", "铂渣");
        provider.add("material.refined_platinum_salt", "精炼铂盐");
        provider.add("material.palladium_salt", "钯盐");
        provider.add("material.rhodium_filter_cake", "铑滤饼");
        provider.add("material.rhodium_nitrate", "硝酸铑");
        provider.add("material.roughly_rhodium_metal", "粗制铑金属");
        provider.add("material.palladium_metal", "钯金属");
        provider.add("material.sodium_rutheniate", "钌酸钠");
        provider.add("material.iridium_dioxide", "二氧化铱");
        provider.add("material.metal_sludge", "金属泥渣");
        provider.add("material.concentrated_platinum", "浓缩铂");
        provider.add("material.rhodium_sulfate_gas", "硫酸铑");
        provider.add("material.palladium_rich_ammonia", "富钯氨");
        provider.add("material.rhodium_salt", "铑盐");
        provider.add("material.ruthenium_tetroxide_hot", "热四氧化钌");
        provider.add("material.ruthenium_tetroxide_lq", "四氧化钌");
        provider.add("material.reprecipitated_rhodium", "再沉淀铑");
        provider.add("material.acidic_iridium", "酸性铱");
        provider.add("material.platinum_metal", "铂金属");
        provider.add("material.sodium_pyrosulfate", "焦硫酸钠");
        provider.add("material.sodium_formate", "甲酸钠");
        provider.add("material.formic_acid", "甲酸");
        provider.add("material.sodium_sulfate", "硫酸钠");
        provider.add("material.sodium_nitrate", "硝酸钠");
        provider.add("material.zinc_sulfate", "硫酸锌");
        provider.add("material.kaolinite", "高岭石");
        provider.add("material.dolomite", "白云石");
        provider.add("material.wollastonite", "硅灰石");
        provider.add("material.arcane_crystal", "神秘水晶");

...
object SelfRecipes {
    ...
    private fun materialRecipes(provider: Consumer<FinishedRecipe>) {
        ...
        GTNNRecipeTypes.LARGE_NAQUADAH_REACTOR_RECIPES.recipeBuilder("thorium_based_liquid_fuel_depleted")
            .inputFluids(GTNNMaterials.ThoriumBasedLiquidFuelExcited.getFluid(1))
            .outputFluids(GTNNMaterials.ThoriumBasedLiquidFuelDepleted.getFluid(1))
            .EUt(-2200)
        ...
        GTNNRecipeTypes.LARGE_NAQUADAH_REACTOR_RECIPES.recipeBuilder("uranium_based_liquid_fuel_depleted")
            .inputFluids(GTNNMaterials.UraniumBasedLiquidFuelExcited.getFluid(1))
            .outputFluids(GTNNMaterials.UraniumBasedLiquidFuelDepleted.getFluid(1))
            .EUt(-12960)
        ...
        GTNNRecipeTypes.LARGE_NAQUADAH_REACTOR_RECIPES.recipeBuilder("plutonium_based_liquid_fuel_depleted")
            .inputFluids(GTNNMaterials.PlutoniumBasedLiquidFuelExcited.getFluid(1))
            .outputFluids(GTNNMaterials.PlutoniumBasedLiquidFuelDepleted.getFluid(1))
            .EUt(-32400)
